...
A **keresztellenőrzés** (Cross-validation) a kulcs e lánc megszakításához. A lényeg nem az, hogy még több ágenst vonjunk be ugyanabba a gondolatláncba, hanem az, hogy az egyik ágens **független nézőpontból** vizsgálja felül a következtetéseket: a korábbi ágens gondolkodási folyamatának figyelmen kívül hagyásával csak azt ellenőrzi, hogy az eredeti bizonyítékok összhangban vannak-e a végső következtetéssel. Ez az 5. fejezetben tárgyalt Javasló-Felülvizsgáló (Proposer-Reviewer) mechanizmus kiterjesztése a többágenses szcenáriókra: a Felülvizsgáló értéke nemcsak a kódhibák vagy formázási problémák megtalálásában rejlik, hanem abban is, hogy független döntéshozóként képes azonosítani az egész gondolatlánc során kollektíven figyelmen kívül hagyott ellentmondásokat. Nagy kockázatú döntések esetén külső ellenőrzési eszközök is bevonhatók.

### Harmadik Hibamód: Korai Leállás és Elszabadult Ciklusok

...
async def get_article_content(
    ...
    try:
        ...
        return TextContent(type="text", text=json.dumps(action_response.model_dump()))
        ...
        action_response = ActionResponse(
            success=False, message=error_msg, metadata={"error_type": "wiki_error"}
        )
...
async def get_article_categories(
    ...
    try:
        ...
        action_response = ActionResponse(
            success=True, message=result, metadata={"language": language}
        )
...
async def get_article_history(
    title: str, date: str, language: str = "en"
) -> Union[str, TextContent]:
    """
    ...
    try:
        ...
        try:
            ...
            raise ValueError("date parts must be valid numeric values")

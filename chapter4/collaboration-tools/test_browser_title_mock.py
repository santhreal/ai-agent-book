...
@pytest.mark.asyncio
async def test_browser_navigate_title_await():
    mock_page = AsyncMock()
...
@pytest.mark.asyncio
async def test_browser_list_tabs_title_await():
    ...
    with patch("browser_tools.init_browser", return_value=mock_browser):
        ...
        mock_page1.title.assert_called_once()
        mock_page2.title.assert_called_once()

...
### مقاييس العملية والسلامة والمتانة

لا تكفي النتيجة النهائية: تقيس نسبة الأفعال الصحيحة والمصرح بها، وصحة معاملات الأدوات، وكفاءة المسار (الخطوات والأفعال المكررة والتراجع)، وتغطية الاسترجاع، والتكلفة والزمن أين تعطل الوكيل. وتطبق العمليات الحساسة وتسريب البيانات والمحتوى المحظور مبدأ **عدم التسامح**؛ كما تقيس المتانة حساسية البذرة وتغير الواجهة واضطراب API وتداخل الذاكرة القديمة. يجب تغطية **المسار** (ما قاله الوكيل وفعله) و**النتيجة** (حالة النظام الفعلية) معًا.
...
### إسناد الفشل واختبارات انحدار بادئة المسار

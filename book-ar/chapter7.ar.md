...
**مسار الاستكشاف في OpenAI** (الذي أرخه Shunyu Yao، أستاذ مساعد بجامعة برينستون ومؤلف ورقة ReAct) يوضح تطور التفكير في هذا المجال:
- **المرحلة الأولى (2015-2016) — أولوية الخوارزمية:** ساد الاعتقاد بأن تطوير خوارزميات أفضل هو المفتاح. وتحققت قفزات في بيئات مثل Atari، لكن كل بيئة جديدة تطلبت إعادة التدريب من الصفر.
- **المرحلة الثانية (2016-2018) — أولوية البيئة:** قامت مجمعات مثل Gym بتوحيد المهام، وتحويل الويب لبيئة تدريب، بينما حققت المشاريع نجاحات في بيئات معقدة محددة مثل Dota 2.
- **المرحلة الثالثة (2018 حتى الآن) — أولوية المعرفة القبلية (Prior):** أظهرت نماذج مثل GPT-2/GPT-3 قوة التدريب المسبق على اللغة، وأثبتت مشاريع مثل WebGPT وChatGPT إمكانية تحويل المعرفة إلى وكلاء عمليين. وكان الاستنتاج المحوري: **يمكن اكتساب المعرفة القبلية بوسائل لا تنفصل عن التدريب المسبق**. والترتيب الحقيقي للمحددات ليس `الخوارزمية > البيئة > المعرفة القبلية` بل **`المعرفة القبلية > البيئة > الخوارزمية`**.
...
تستغني **خوارزمية GRPO** عن شبكة الناقد (Critic Network) — وهي شبكة عصبية مساعدة يُدربها PPO لتقدير دالة القيمة في كل خطوة بحساب الميزات الدقيقة. وبدلاً من ذلك، تعتمد GRPO على **تقدير الميزة النسبية داخل المجموعة (Group-Relative Advantage Estimation)**: فنأخذ $N$ عينة مسار للمسألة نفسها للحصول على المكافآت $r_1,\dots,r_N$، وتُحدد ميزة كل مسار بناءً على أدائه النسبي بالنسبة لمتوسط وانحراف المجموعة:

$$\hat{A}_i = \frac{r_i - \operatorname{mean}(r_1,\dots,r_N)}{\operatorname{std}(r_1,\dots,r_N)}$$

وهذا يعني إسناد ميزة إيجابية إذا كان المسار أفضل من متوسط المجموعة، وسلبية إذا كان أدنى — دون الحاجة لشبكة قيمة، وهو ما يقلل التكلفة الحاسوبية بشكل كبير.

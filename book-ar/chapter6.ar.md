...
أما افتتاح الفصل بـ**اللاتزامن والتوجّه بالأحداث** فلأنه الأقرب إلى القارئ: الوسيط ما زال نصًّا خالصًا، والمتغيّر هو التوقيت وحده. وهو الخطوة الأولى خارج العالم التناوبي في الفصول الخمسة السابقة، وأول موضع تلامس فيه أطروحة "افتراض التناوب" أرض الواقع.

## اللاتزامن والتوجّه بالأحداث: حين يأتي العالم إليك

أدوات الإدراك والتنفيذ والتعاون الثلاث التي ناقشها الفصل الرابع يستدعيها Agent بنفسه، فهو الذي يقرّر متى ينظر ومتى يتحرّك. وينتقل هذا القسم إلى الطرف الأبطأ من محور التوقيت: كيف يدير Agent مهامّ تستغرق ساعات بل أيامًا، وكيف يستجيب لأحداث خارجية قد تصل في أي لحظة؟ يستلزم ذلك بنية لا متزامنة موجّهة بالأحداث؛ والفئتان الباقيتان من فئات الأدوات الخمس في الفصل الأول — أدوات إطلاق الأحداث وأدوات التواصل مع المستخدم — إنما تعملان استنادًا إلى هذه البنية، ولذلك تُناقشان في هذا القسم أيضًا.
...
> جدول 6-1 نتائج MiniCPM-o 4.5 محليًّا: من طرف إلى طرف مقابل التتالي الذاتي (4 فحوص آليّة، لا معيار مرجعي)
>
>
...
>
> العينة صغيرة ولا تثبت أي المسارين أدق أو أسرع عمومًا. العتاد والإصدارات والمخرجات الخام ودليل الصوت الحقيقي في [chapter6/end-to-end-speech](../chapter6/end-to-end-speech/).
...
وتجعل MPS دماغ التصوّر ينتج مقاطع تفكير متتابعة، فيما يتلقّى دماغ التعبير المقطع ويولّد الكلام فورًا مركّبًا إياه على ما سبق من الرد. ويتوازى الدماغان على هيئة خط أنابيب، فلا يلزم انتظار اكتمال التفكير كله ليسمع المستخدم الجملة الأولى (الشكل 6-11).


![الشكل 6-11: بنية الدماغين MGRD وMPS في Step-Audio R1](images/fig6-11.svg)
...
يسمح استخدام الكمبيوتر، المعروف أيضًا باسم أتمتة واجهة المستخدم الرسومية، للذكاء الاصطناعي باستخدام البرامج مثل الإنسان من خلال مراقبة الشاشة وتشغيل الماوس ولوحة المفاتيح - على سبيل المثال، فتح متصفح للبحث عن المعلومات، أو ملء البيانات في تطبيق جدول بيانات، أو ضبط التكوينات في إعدادات النظام. جوهرها هو حلقة **الإدراك والتفكير والفعل** (الشكل 6-12):
...
![الشكل 6-12: حلقة الإدراك والتفكير والتصرف الخاصة بوكيل استخدام الحاسوب](images/fig6-12.svg)
...
يحدد Anthropic ثلاثة أنواع من الأدوات التي تشكل قدرة تفاعل كاملة (الشكل 6-13):

![الشكل 6-13: مساحة عمل استخدام الكمبيوتر](images/fig6-13.svg)
...
>
> يستخدم المسار B المشروع المرافق للكتاب [`chapter6/computer-use-open-model`](../chapter6/computer-use-open-model/). وهو يشغّل browser-use افتراضيًا بالنموذج مفتوح الأوزان Qwen3-VL 32B Instruct، إما عبر API المستضاف في OpenRouter، أو بتوجيه `OPEN_MODEL_BASE_URL` إلى vLLM/SGLang مستضاف ذاتيًا أو إلى نقطة نهاية متوافقة أخرى. يجب أن تقبل نقطة النهاية لقطات الشاشة وأن تدعم JSON Schema الأصلي؛ وإذا كانت تدعم JSON العادي فقط، فيمكن تفعيل وضع التوافق schema-in-prompt صراحةً.
>
...
![الشكل 6-14: مجموعة العلامات مقابل فهرسة العناصر الهيكلية (تنفيذ استخدام المتصفح)](images/fig6-14.svg)
...
[^ch6-9]: للحصول على الآلية الكاملة والاستئصال لكل نموذج للمكونات الثلاثة - الإطارات الرئيسية المسورة، والنسخ حسب الطلب، وإطارات السرد إلى نص ثابت - راجع Bojie Li وNoah Shi. *واجهات مراقبة الوكيل والكمبيوتر تتيح الاستخدام الديناميكي للكمبيوتر.* arXiv:2606.29472, 2026.
...
المقاطع القصيرة أسرع استجابة لكنها تضاعف استدعاءات النموذج؛ والطويلة أكثر سلاسة لكنها أميل إلى استعمال رصد فات أوانه. تقارن التجربة 6-12 هذا النوع من المقايضات في المحاكي، أما ما يلامس حدود سلامة العتاد الحقيقي فهو التجربة 6-11.
...
ما رفعه هذا الفصل هو تلك المقدّمة التي ظلّت الفصول الخمسة السابقة تفترضها: أن Agent والعالم يتناوبان الكلام.

وإذا نظرنا على امتداد محورَي **الوسيط** و**التوقيت**، تبيّن أن الأقسام الأربعة أطروحة واحدة تنبسط على أربعة مقاييس زمنية. فـ**اللاتزامن والتوجّه بالأحداث** يوسّع الملاحظة من "يذهب Agent إليها" إلى "يدفعها العالم"، ويوسّع الفعل من "الإنجاز داخل الجولة" إلى "الإطلاق أولًا ثم الختم بحدث"، والوسيط لم يتغيّر، وإنما تغيّر التوقيت وحده. و**الصوت** يضغط المقياس إلى المللي ثانية، وخط تطوّر النماذج الثلاثة — التسلسل والنموذج الشامل من طرف إلى طرف والازدواج الكامل — هو بعينه الانتقال من "الكلام بالتناوب" إلى الإنصات والكلام المتصلين، مع توزيع العمل بين تفاعل آني في المقدّمة وتفكير عميق في الخلفية. و**Computer Use** ينقل الحلقة نفسها إلى الشاشة، حيث اتّسع عنق الزجاجة من "هل تُنجَز المهمة" إلى كفاءة التشغيل والفهم البصري المتصل والتأكّد من الحالة بعد الفعل. أما **الروبوت** فيدفعها إلى العالم الفيزيائي، حيث توازن تجزئة الفعل بين السلاسة وسرعة الاستجابة، ويظلّ الحكم بالإنجاز من عدمه موكولًا إلى ملاحظة جديدة.
...
كما تتشارك مجموعة الأوّليات نفسها: الإيقاظ، نقطة الأمان، الإلغاء، المزاحمة، وفصل السريع عن البطيء. فقولنا في حلقة الأحداث "تحقّق من إشارة الإلغاء عند نقطة أمان"، وقولنا في تجزئة الفعل "إذا ظهر خلل فألقِ البقية وأعد الملاحظة"، تطبيقان لآلية واحدة على مقياسين يفصل بينهما خمس مراتب عشرية؛ وتوزيع العمل بين نموذج سريع في المقدّمة وآخر بطيء في الخلفية، و"إعادة معرّف المهمة أولًا ثم ختمها لاحقًا بحدث" في Agent اللا متزامن، صيغتان لشيء واحد كذلك.

وينبغي الالتفات إلى أن أكثر هذه الآليات لا يزال حتى الآن حلولًا هندسية مؤقّتة. فبروتوكولات العناصر النائبة، وعلامات الأحداث في شريط الحالة، وإلغاء التفكير الاستباقي والتراجع عنه، كلها في جوهرها تعوّض بمنطق التنسيق عن خبرة لا متزامنة غائبة عن توزيع تدريب النموذج. والتقدّم في جانب النموذج يضمّ بعض ذلك إلى المعاملات — فنماذج التفاعل أدخلت المقاطعة والاعتراض إلى داخل النموذج، والتفكير المتصل جعل "التفكير أثناء الإنصات" ممكنًا دون انتظار الجيل التالي — لكن ما دامت ذخائر التدريب تناوبية في معظمها، فلن تزول طبقة التعويض هذه؛ ستنتقل فحسب إلى حدود جديدة كلما تقدّمت قدرة النموذج.

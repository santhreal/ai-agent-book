...
جدول 6-3 السيناريوهات المطبقة على مقاييس Pass@k وPass^k

| هدف التقييم | المقياس المناسب | عواقب سوء الاستخدام |
|----------------------------------|---------------|-----------------------------------------------|
| **التحقق من الاستقرار** (اختبار عدم التراجع) | **Pass^k** | استخدام Pass@k يخفي عدم الاستقرار — فالوكيل الذي ينجح مرة واحدة فقط من 5 محاولات سيُحسب كأنه مجتاز |
| **تقييم سقف القدرة** (المهام الاستكشافية) | **Pass@k** أو **Best@k** | استخدام Pass^k قد يصنف التغييرات الناجحة خطأ كفشل بسبب تقلبات عشوائية بسيطة |

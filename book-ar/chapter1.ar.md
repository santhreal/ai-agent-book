...
## حلقة الاكتشاف: الدليل، والاقتراح، والتجربة، والتغذية الراجعة

أنماط القسم السابق الخمسة بِنى موضعية. وثمة بنية أكبر تمتدّ عبر ثلاثة فصول، لكنها لمّا بُنيت مجزّأة صار من السهل أن تُحسَب ثلاثة مسارات مستقلّة.

على الفصل السابع أن يحدّد أول خطأ في مسار فاشل وأن يصنّفه. وعلى الفصل الثالث أن يحوّل دليلًا جديدًا إلى أصغر تعديل مؤسَّس ممكن في قاعدة المعرفة. وعلى الفصل التاسع أن يحكم هل جعل التعديلُ النظامَ أفضل حقًّا، ثم أن يقرّر النشر أو التراجع. وهذه الثلاثة تستعمل آليات مختلفة تمامًا — فالعزو يقوم على المعايير الوصفية (Rubric) وتحديد موضع أول خطأ، والاقتراح على نمط المقترِح—المراجِع، والتحقّق على مجموعة الحدود ومجموعة الاحتفاظ مع النشر التدريجي والتراجع — ولذلك فهي **ليست تكرارًا ثلاثيًّا لآلية واحدة**، وتوحيد مفرداتها قسرًا يحجب الفروق التي تهمّ فعلًا.

والمشترك بينها حقًّا هو الموضع: كلٌّ منها يشغل قطعة من الحلقة نفسها.

```text
الدليل (الفصل السابع): مسار فاشل ← أول خطأ + صنف الخطأ
  ← الاقتراح (الفصل الثالث): دليل ← تعديل واحد أصغري قابل للمراجعة والتراجع
  ← التجربة (الفصل التاسع): قياس على مجموعتَي الحدود والاحتفاظ، ونشر تدريجي
  ← التغذية الراجعة: نتائج القياس والمسارات الفاشلة الجديدة تعود إلى قطعة الدليل
```

وقد سمّت هذه الحلقةَ مؤخّرًا شركةُ Discovery Loop التي أسّسها Jeff Dean وزملاؤه، ودفعتها نحو الأتمتة: اقترح تجربة، ونفّذ ما تحتاجه، وقيّمها، واحمل النتيجة إلى الجولة التالية، وحوّل عملية كانت تجري تسلسليًّا إلى عملية متوازية[^ch1-discovery-loop]. وينبغي القول صراحةً إن الشركة تأسّست في أغسطس 2026 ولم تنشر حتى الآن سوى رسالتها، دون نتائج تقنية معلنة؛ وهذا الكتاب يستشهد بها من أجل **تسميتها للحلقة**، لا بوصفها دليلًا — وهو التمييز نفسه الذي سيلحّ عليه الفصل السابع.

وإذا وُضِعت حلقة نظام Agent إلى جانب حلقة بحثية خالصة تبيّن أن على الأولى قيدين إضافيين، وهما تحديدًا ما يعالجه القسم الأكبر من بقية هذا الكتاب. **الأول: يجب أن تكون التجربة متجذّرة في ملاحظة حقيقية.** ففي الحلقة البحثية قد تكون «التجربة» شوطَ تدريب، أما في نظام Agent فهي تعدّل نظامًا يخدم مستخدمين في هذه اللحظة؛ ولذلك يجب أن يأتي الحكم من الحالة الفعلية للبيئة — هل نجحت الاختبارات، وما الحالة النهائية لقاعدة البيانات، وماذا أعادت الأداة — لا من إعادة النموذج سرد سلوكه بنفسه. **والثاني: على كل تجربة أن تجيب معًا عن «ماذا أصلحت» و«ماذا أفسدت».** الحلقة البحثية تكتفي غالبًا بارتفاع المقياس، أما نظام Agent فعليه أن يثبت كذلك أنه لم يفسد سلوكًا كان صحيحًا أصلًا. وهذا سبب وجود مجموعة الحدود ومجموعة الاحتفاظ في القسم السابق.

وتتناول الفصول الثلاثة التالية كلٌّ منها قطعته وحدها، ولا تعيد سرد الحلقة كاملة: الفصل الثالث في ما يجعل الاقتراح مؤسَّسًا، والفصل السابع في ما يجعل الدليل موثوقًا، والفصل التاسع في ما يُبقي التجربة والتغذية الراجعة تدوران طويلًا دون تشتّت.

[^ch1-discovery-loop]: أُعلن تأسيس Discovery Loop في 5 أغسطس 2026 على يد Jeff Dean وSanjay Ghemawat وQuoc Le وOriol Vinyals، وهي public benefit corporation رسالتها أتمتة تعلّم الآلة والعلم والهندسة؛ ووصفها المعلن هو أتمتة حلقات تجريبية كاملة وموازاة ما كان يجري تسلسليًّا على نطاق واسع. انظر https://techcrunch.com/2026/08/05/jeff-dean-and-other-top-ai-researchers-are-leaving-google-to-launch-their-own-startup/ . وحتى وقت كتابة هذا الكتاب لم تنشر نتائج تقنية قابلة لإعادة الإنتاج.
...
**حلقة الاكتشاف تمتدّ عبر ثلاثة فصول**: الدليل (عزو الإخفاق في الفصل السابع) ← الاقتراح (تحديث المعرفة في الفصل الثالث) ← التجربة والتغذية الراجعة (التحقّق والنشر في الفصل التاسع). والقطع الثلاث تستعمل آليات مختلفة فعلًا؛ والمشترك بينها الموضع لا المفردات. وبالقياس إلى الحلقة البحثية الخالصة، تحمل حلقة نظام Agent قيدين إضافيين: أن تكون التجربة متجذّرة في ملاحظة حقيقية، وأن تجيب كل جولة معًا عمّا أصلحته وما أفسدته.

...
| **سياق العمل** | السياق | **فضاء الملاحظات (Observation Space)** | جميع المعلومات المتاحة للوكيل — ما يمكنه ملاحظته وقراءته واسترجاعه من البيئة |
| **واجهات الفعل** | الأدوات | **فضاء الأفعال (Action Space)** | مجموعة الأفعال المتاحة للوكيل — من تنفيذ الشفرة والبحث إلى التواصل والتحكم في الواجهات |

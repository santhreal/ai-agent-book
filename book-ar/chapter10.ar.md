...
النظر في سيناريو محدد. لنفترض أن نظام الترجمة يستخدم نمط المدير (الهندسة المعمارية من التجربة 10-2)، حيث يقوم المدير بتعيين فصول كتاب تقني لوكلاء ترجمة متعددين:
...
وكيل الترجمة ب: يترجم الفصل الثامن، ويترجم inference latency أيضًا إلى «推理 latency»

...
>
> Сопутствующая реализация находится в [`trajectory-verifier`](../chapter9/trajectory-verifier/); по умолчанию используется воспроизводимый офлайн Judge качества, а параметр `--judge llm` запускает уже реализованный настоящий LLM-проверяющий.

...
**Перекрёстная проверка** (Cross-validation) — ключевое средство разрыва этой цепи. Суть состоит не в том, чтобы привлечь больше Agent к одной и той же цепи рассуждений, а в том, чтобы один из Agent переосмыслил выводы с **независимой позиции**: не глядя на ход мыслей предшествующих Agent, а проверяя лишь соответствие исходных доказательств и итогового заключения. Это расширение механизма «предлагающий — рецензент», рассмотренного в пятой главе, на многоагентные сценарии: ценность рецензента заключается не только в обнаружении ошибок в коде или форматировании, но и в роли независимого арбитра, способного выявить противоречия, коллективно упущенные всей цепочкой рассуждений. Для высокорисковых решений можно также привлекать внешние средства проверки.

...
**Xác minh chéo** (Cross-validation) là phương pháp then chốt để cắt đứt chuỗi này. Cốt lõi không phải là đưa thêm nhiều Agent vào cùng một chuỗi suy nghĩ, mà là để một Agent xem xét lại kết luận từ một **góc nhìn độc lập**: không nhìn vào quá trình suy nghĩ của Agent trước đó, chỉ kiểm tra xem bằng chứng gốc và kết luận cuối cùng có nhất quán hay không. Đây chính là sự mở rộng của cơ chế Người đề xuất - Người đánh giá (Proposer-Reviewer) đã thảo luận ở Chương 5 sang kịch bản đa Agent: giá trị của Người đánh giá không chỉ nằm ở việc phát hiện lỗi code hay sự cố định dạng, mà quan trọng hơn là với tư cách một người phán xử độc lập, nó có thể nhận diện những mâu thuẫn bị bỏ qua một cách tập thể trong toàn bộ chuỗi suy nghĩ. Đối với các quyết định có rủi ro cao, còn có thể đưa vào các phương thức xác minh bên ngoài.

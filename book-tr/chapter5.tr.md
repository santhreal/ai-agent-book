...
Bu ipliği izlemek—içeriden dışarıya, nihayetinde Agent'ın kendisine geri dönerek—kodun meta-yetenek olarak birleşik değerini görmeyi kolaylaştırır. Bölüm 9 bu temel üzerine kurularak hangi operasyonel kanıtın öz-değişikliği tetiklemesi gerektiğini ve aday değişikliklerin test, yayınlama ve geri alma yoluyla yeni bir sürüme nasıl girdiğini inceler.
...
Kitabın “Agent İnşa Etme” kısmını artık tamamladık; kod üretimi de bu kısmın en genel meta-yeteneğidir. Ancak kilit bir soru hâlâ yanıtsızdır: bu tasarım kararlarının etkisini bilimsel olarak nasıl ölçebiliriz? Bir sonraki bölümle birlikte kitap “Değerlendirme ve Evrim” kısmına geçer. Bölüm 7; değerlendirme ortamlarını, veri kümelerini, otomatik yargıyı ve model seçimini kapsayan bir metodoloji geliştirir. Bölüm 8 ve 8 ise sırasıyla parametre düzeyinde ve Agent sisteminin tamamında sürekli iyileştirmeyi ele alır.

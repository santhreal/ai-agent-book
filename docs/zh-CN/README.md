...
| 5 | 💻 **Coding Agent 与代码生成** | 代码是「能创造新工具的工具」，生产级 Coding Agent 全景 | [读](../../book/chapter5.md) | [13](../../chapter5/README.md) |
...
第 6、7、9、10 章的 23 个外部仓库（基准测试、训练框架、机器人平台）因体积和许可原因**未打包**，需自行 clone 到对应目录。
...
# 第 7 章 · 训练框架（bojieli/* 为本书适配 fork）
git clone https://github.com/bojieli/minimind.git                      chapter7/MiniMind-pretrain/minimind      # 实验 7-3 从零训练 LLM
git clone https://github.com/bojieli/minimind-v.git                    chapter7/MiniMind-pretrain/minimind-v    # 实验 7-4 从零训练 VLM（投影层）
...
git clone https://github.com/joonspk-research/generative_agents.git    chapter10/generative_agents             # 实验 10-7 Stanford AI Town
```

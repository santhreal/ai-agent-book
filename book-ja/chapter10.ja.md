...
**相互検証**（クロスバリデーション）はこの連鎖を断ち切る鍵となります。その中核は、同じ思考チェーンにより多くの Agent を参加させることではなく、いずれかの Agent に**独立した視点**で結論を再検討させることです。つまり、前続の Agent の思考プロセスは見ず、生の証拠と最終結論が一致しているかだけを検証します。これは第5章で論じたプロポーザー-レビュアー機構のマルチ Agent シナリオへの拡張です。レビュアーの価値は、コードエラーやフォーマット問題を発見することだけでなく、独立した判定者として思考チェーン全体で集団的に見落とされた矛盾を識別することにあります。高リスクな意思決定については、外部の検証手段を導入することも可能です。

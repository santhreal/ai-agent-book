...
We have now completed the book's “Building Agents” part—and code generation is its most general meta-capability. But one key question remains unanswered: how can the effects of these design decisions be measured scientifically? Beginning with the next chapter, the book turns to “Evaluation and Evolution.” Chapter 7 develops a methodology spanning evaluation environments, datasets, automated judgment, and model selection; Chapters 8 and 8 then discuss continuous improvement at the parameter level and across the entire Agent system, respectively.
